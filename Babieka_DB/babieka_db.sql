...
VALUES 
    ('Sandalia de fiesta con plataforma alta. Capellada de cuero con detalle reptil, y taco forrado en el mismo material. La suela es de material rigido sintetico, con tope de goma en el taco. Plataforma de 5 cm de alto y 11 cm de taco.'),
    ('Sandalia de fiesta con plataforma alta. Capellada de cuero con detalle reptil, y taco forrado en el mismo material. La suela es de material rigido sintetico, con tope de goma en el taco. Plataforma de 5 cm de alto y 11 cm de taco.'),
    ('Sandalia de fiesta con plataforma alta. Capellada de Glitter con aplique de flores. Taco forrado en el mismo material. La suela es de material rigido sintetico, con tope de goma en el taco. Plataforma de 5 cm de alto y 11 cm de taco.'),
    ('Sandalia de fiesta con plataforma alta. Capellada de cuero y taco forrado en el mismo material con tachas. La suela es de material rigido sintetico, con tope de goma en el taco. Plataforma de 5 cm de alto y 11 cm de taco.'),
    ('Sandalia de fiesta con plataforma alta. Capellada de glitter con aplique de piedras, y taco forrado en el mismo material. La suela es de material rigido sintetico, con tope de goma en el taco. Plataforma de 5 cm de alto y 11 cm de taco.'),
    ('Sandalia de fiesta con plataforma alta. Capellada de glitter calada con brillos, y taco forrado en el mismo material. La suela es de material rigido sintetico, con tope de goma en el taco. Plataforma de 5 cm de alto y 11 cm de taco.'),
    ('Sandalia de fiesta con plataforma alta. Capellada de raso y taco forrado con sintetico estampado. La suela es de material rigido sintetico, con tope de goma en el taco. Plataforma de 5 cm de alto y 11 cm de taco.'),
    ('Sandalia de fiesta con plataforma alta. Capellada de raso, y taco forrado en glitter. La suela es de material rigido sintetico, con tope de goma en el taco. Plataforma de 5 cm de alto y 11 cm de taco.'),
    ('Botinetas de cuero combinado, taco aguja. Suela rigida, con tope de goma antideslizante en el taco, altura 9 cm.'),
    ...
    ('Mule de cuero negro. Capellada con detalle de rosa bordada y herraje. El interior se encuentra forrado en simil cuero. La suela es de goma antideslizante.'),
    ('Zapato de plataforma de charol y raso. Plataforma de 4 cm y taco de 8 cm.'),
    ('Sandalia de cuero. Fondo de madera con suelin de goma de 5 cm de plataforma y 11 cm de taco.'),
    ('Sandalia de cuero con detalle de capellada trenzada. Fondo de madera con suelin de goma de 5 cm de plataforma y 11 cm de taco.'),
    ('Sandalia de cuero. Fondo de madera con suelin de goma de 5 cm de plataforma y 11 cm de taco.'),
    ...
    ('Bota texana confeccionada en cuero reptil, con detalle de herrajes y tachas. El interior esta forrado en tela y material simil cuero. Su suela y taco son de goma con antideslizante, altura del taco 4 cm.'),
    ('Bota Texana de cuero, con detalle de flecos. El interior esta forrado en tela y material simil cuero. Su suela y taco son de goma con antideslizante, altura del taco 4 cm.'),
    ('Sandalia cruzada de cuero con detalle de tachas en la capellada. Fondo de goma, 5 cm de alto.');
